...
- (CVPixelBufferRef __nonnull)panelDelegateGenerator:(PLPanelDelegateGenerator *_Nullable)panelDelegateGenerator cameraSourceDidGetPixelBuffer:(CVPixelBufferRef __nonnull)pixelBuffer timingInfo:(CMSampleTimingInfo)timingInfo;
