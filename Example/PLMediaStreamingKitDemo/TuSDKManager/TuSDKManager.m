...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        _thirdPartyOrg = TuThirdPartyOrg_UKnown;
    }
    return self;
}
...
- (void)configTuSDKViewWithSuperView:(UIView*)superView
{
    ...
    [_pipeOprationQueue runSync:^{
        ...
        if (self->_thirdPartyOrg == TuThirdPartyOrg_QiNiu) {
...
- (void)initModuleBtn
{
    ...
    if (!_filterButton)
    {
        _filterButton = [[UIButton alloc]initWithFrame:CGRectMake(startX, btnMinY, 46, 46)];
    ...
    if (_enableLiveSticker)
    {
        if (!_stickerButton)
        {
            _stickerButton = [[UIButton alloc]initWithFrame:CGRectMake(startX, btnMinY + 60, 46, 46)];
    ...
    if (_enableLiveBeauty)
    {
        if (!_beautyButton)
        {
            _beautyButton = [[UIButton alloc]initWithFrame:CGRectMake(startX, btnMinY + 120, 46, 46)];
